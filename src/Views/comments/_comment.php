<?php
// Individual comment template (recursive for threading) - Lobsters structure
?>
<li class="comments_subtree">
    <input type="checkbox" class="comment_folder_button" id="fold_<?=$comment['short_id']?>">
    <div class="comment" id="comment-<?=$comment['short_id']?>" data-comment-id="<?=$comment['id']?>">
        ...
        <div class="details">
            <div class="byline">
                <label for="fold_<?=$comment['short_id']?>" class="comment_folder"></label>
                ...
                <span class="comment_actions">
                    <a href="#" class="comment_replier" data-comment-id="<?=$comment['id']?>">reply</a>
                    
                    <?php if (isset($_SESSION['user_id'])) : ?>
                        <a href="#" class="flagger" data-comment-id="<?=$comment['id']?>">flag</a>
                    <?php endif ?>
            ...
            <div class="comment_text" data-comment-id="<?=$comment['id']?>">
