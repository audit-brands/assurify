...
<div class="messages-page">
    <div class="messages-header">
        ...
        <div class="messages-nav">
            ...
            <a href="/messages/sent" class="nav-link active">Sent</a>
            ...
            <?php foreach ($messages as $message) : ?>
                <div class="message-item">
                    <div class="message-participants">
                        ...
                        <?php if (!$message['has_been_read']) : ?>
                            <span class="unread-indicator" title="Message not yet read">◯</span>
                        <?php else : ?>
                            <span class="read-indicator" title="Message has been read">●</span>
                        <?php endif ?>
                    </div>
                    ...
                    <div class="message-meta">
                        ...
                        <div class="message-actions">
                            ...
                            <a href="/messages/compose?to=<?= urlencode($message['recipient_username']) ?>&subject=<?= urlencode('Re: ' . $message['subject']) ?>" class="action-link">Reply</a>
                        </div>
                    </div>
                </div>
            <?php endforeach ?>
    ...
    <?php if (count($messages) >= 25) : ?>
        <div class="pagination">
            <?php if ($current_page > 1) : ?>
                <a href="/messages/sent?page=<?= $current_page - 1 ?>" class="pagination-link">&laquo; Previous</a>
            <?php endif ?>
            <span class="pagination-info">Page <?= $current_page ?></span>
            <a href="/messages/sent?page=<?= $current_page + 1 ?>" class="pagination-link">Next &raquo;</a>
        </div>
    <?php endif ?>
</div>
